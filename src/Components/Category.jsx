        ...
        <div className="max-w-3xl mx-auto">
            ...
            <div className="flex space-x-4"> {/* Adjusted line */}
                ...
                <div className="text-left w-3/4 ">
                    <h3 className="text-2xl font-bold ml-2">{bookName}</h3>
                    <p className="text-lg text-gray-800 ml-2">{author}</p>
                    <div className="flex">
                        <p className="text-lg text-blue-600 m-2 font-semibold">{score}/5
                            <span className="text-lg">⭐</span>
                        </p>
                        <p className="text-lg text-gray-700 m-2 pl-2 font-semibold">{release}</p>
                    </div>
                    <p className="text-lg text-gray-600 m-2 font-semibold w-128">{summary}</p>
                </div>
            </div>
